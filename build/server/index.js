import { r as render, s as set, L as LEGACY_PROPS, g as get, f as flushSync, d as define_property, m as mutable_source, i as init_operations, a as get_first_child, H as HYDRATION_START, b as get_next_sibling, c as HYDRATION_ERROR, e as HYDRATION_END, h as hydration_failed, j as clear_text_content, k as array_from, l as component_root, n as is_passive_event, o as create_text, p as branch, q as push, t as setContext, u as pop, v as push$1, w as component_context, x as active_effect, y as pop$1, D as DEV } from './chunks/index-d9yomiCc.js';
import { a as all_registered_events, r as root_event_handles, h as handle_event_propagation } from './chunks/events-CdTAYaIN.js';
import { s as set_app, H as HttpError, j as json, t as text, R as Redirect, S as SvelteKitError, a as stringify, A as ActionFailure, i as is_primitive, g as get_type, D as DevalueError, b as is_plain_object, e as enumerable_symbols, c as stringify_key, d as stringify_string, f as escaped } from './chunks/app-7kTdB7Wo.js';
import { d as decode_pathname, a as decode_params, n as normalize_path, b as disable_search, v as validate_layout_server_exports, c as validate_layout_exports, e as validate_page_server_exports, f as validate_page_exports, r as resolve, m as make_trackable, g as readable, w as writable } from './chunks/exports-J2AlltLs.js';
...
async function get_hooks() {
  ...
  let handleError;
  let init;
  ({ handle, handleFetch, handleError, init } = await import('./chunks/hooks.server-DCWMKrRh.js'));
  let reroute;
  let transport;
  ({ reroute, transport } = await import('./chunks/hooks-BJZMCFgz.js'));
  return {
    handle,
    handleFetch,
    handleError,
