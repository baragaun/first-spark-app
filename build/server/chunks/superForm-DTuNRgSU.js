import { q as push, V as copy_payload, W as assign_payload, u as pop, E as bind_props, I as spread_props, t as setContext, Q as derived, B as escape_html, O as spread_attributes, P as clsx, F as getContext, z as ensure_array_like, a4 as clsx$1, J as store_get, R as attr_class, a9 as store_mutate, K as unsubscribe_stores, M as sanitize_props, T as slot, D as DEV } from './index-d9yomiCc.js';
...
import { r as parse$1, u as useId$1, b as box$1, m as mergeProps$1, a as useRefById$1, t as getDefaultExportFromCjs } from './noop-kcrjqjA1.js';
import { h as get, w as writable, i as derived$1, j as readonly } from './exports-J2AlltLs.js';
...
import { a as applyAction, i as invalidateAll } from './client-BNK9U2wL.js';
import { U as UNDEFINED, N as NAN, P as POSITIVE_INFINITY, h as NEGATIVE_INFINITY, k as NEGATIVE_ZERO, l as decode64, m as HOLE, a as stringify, n as app } from './app-7kTdB7Wo.js';
import { z, ZodFirstPartyTypeKind, ZodOptional } from 'zod';
import { o as onDestroy, t as tick } from './index-server-DeHLhTK0.js';
...
const en_setting_username_suggest_new = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Suggest new`;
  }
);
const es_setting_username_suggest_new = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Sugerir nuevo`;
  }
);
const setting_username_suggest_new = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_username_suggest_new", locale);
  if (locale === "en") return en_setting_username_suggest_new();
  if (locale === "es") return es_setting_username_suggest_new();
  return "setting.username.suggest_new";
};
const en_setting_username_generating = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Generating...`;
  }
);
const es_setting_username_generating = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Generando...`;
  }
);
const setting_username_generating = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_username_generating", locale);
  if (locale === "en") return en_setting_username_generating();
  if (locale === "es") return es_setting_username_generating();
  return "setting.username.generating";
};
const en_form_button_default_buttontext1 = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Submit`;
  }
);
const es_form_button_default_buttontext1 = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Enviar`;
  }
);
const form_button_default_buttontext1 = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("form_button_default_buttontext1", locale);
  if (locale === "en") return en_form_button_default_buttontext1();
  if (locale === "es") return es_form_button_default_buttontext1();
  return "form_button_default.buttonText";
};
const en_form_button_default_successtext1 = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Success!`;
  }
);
const es_form_button_default_successtext1 = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `¡Éxito!`;
  }
);
const form_button_default_successtext1 = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("form_button_default_successtext1", locale);
  if (locale === "en") return en_form_button_default_successtext1();
  if (locale === "es") return es_form_button_default_successtext1();
  return "form_button_default.successText";
};
const en_form_button_default_loadingtext1 = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Processing...`;
  }
);
const es_form_button_default_loadingtext1 = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Procesando...`;
  }
);
const form_button_default_loadingtext1 = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("form_button_default_loadingtext1", locale);
  if (locale === "en") return en_form_button_default_loadingtext1();
  if (locale === "es") return es_form_button_default_loadingtext1();
  return "form_button_default.loadingText";
};
...
function isBox(value) {
  return isObject$1(value) && BoxSymbol in value;
}
...
function Form_button$1($$payload, $$props) {
  push();
...
function Form_button($$payload, $$props) {
  ...
  let {
    ...
    isLoading = false,
    isSuccess = false,
    buttonText = /* @__PURE__ */ form_button_default_buttontext1(),
    loadingText = /* @__PURE__ */ form_button_default_loadingtext1(),
    successText = /* @__PURE__ */ form_button_default_successtext1(),
    variant = "default",
    fullWidth = true,
    type = "submit",
    onClick = void 0,
  ...
  function icon($$payload2) {
    $$payload2.out += `<div class="mx-2">`;
    Spin_load_indicator($$payload2, { isLoading, isSuccess });
    $$payload2.out += `<!----></div>`;
  }
  $$payload.out += `<!---->`;
  Form_button$1($$payload, {
    variant,
    disabled,
    type,
    ...
    children: ($$payload2) => {
      ...
      if (isLoading) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `${escape_html(loadingText)}`;
        icon($$payload2);
        $$payload2.out += `<!---->`;
      } else if (isSuccess) {
        $$payload2.out += "<!--[1-->";
        $$payload2.out += `${escape_html(successText)}`;
        icon($$payload2);
        $$payload2.out += `<!---->`;
      } else {
        $$payload2.out += "<!--[!-->";
        $$payload2.out += `${escape_html(buttonText)}`;
      }
      $$payload2.out += `<!--]--></div>`;
    },
    $$slots: { default: true }
...
function Form_ident_input($$payload, $$props) {
  push();
  var $$store_subs;
  let {
    form,
    ...
    isLoading = false,
    suggestUsername = void 0
  } = $$props;
  const { form: formData, errors } = form;
  const isUserHandle = identType === UserIdentType.userHandle;
  let $$settled = true;
  let $$inner_payload;
  function $$render_inner($$payload2) {
    $$payload2.out += `<!---->`;
      ...
      children: ($$payload3) => {
        $$payload3.out += `<!---->`;
        {
          let children = function($$payload4, { props }) {
            $$payload4.out += `<div class="space-y-2"><div class="flex items-center justify-between"><div class="flex h-6 items-center"><!---->`;
            Form_label($$payload4, {
              children: ($$payload5) => {
            ...
            $$payload4.out += `<!----></div> `;
            if (isUserHandle && suggestUsername && store_get($$store_subs ??= {}, "$errors", errors)[fieldName]) {
              $$payload4.out += "<!--[-->";
              $$payload4.out += `<button type="button"${attr_class(clsx(cn("inline-flex h-6 items-center justify-center rounded-md px-2 text-xs font-medium", "ring-offset-background transition-colors hover:bg-muted hover:text-muted-foreground", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2", "disabled:pointer-events-none disabled:opacity-50")))}>`;
              Refresh_cw($$payload4, {
                class: cn("mr-1 h-3 w-3", isLoading && "animate-spin")
              });
              $$payload4.out += `<!----> ${escape_html(isLoading ? /* @__PURE__ */ setting_username_generating() : /* @__PURE__ */ setting_username_suggest_new())}</button>`;
            } else {
              $$payload4.out += "<!--[!-->";
            }
            $$payload4.out += `<!--]--></div> <div class="relative w-full">`;
            ...
            $$payload4.out += `<!----> `;
            if (isUserHandle && store_get($$store_subs ??= {}, "$formData", formData)[fieldName]) {
              $$payload4.out += "<!--[-->";
              if (isLoading) {
                $$payload4.out += "<!--[-->";
                $$payload4.out += `<div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3"><div class="h-4 w-4 animate-spin rounded-full border-2 border-muted-foreground border-t-transparent"></div></div>`;
              } else if (!store_get($$store_subs ??= {}, "$errors", errors)[fieldName]) {
                $$payload4.out += "<!--[1-->";
                $$payload4.out += `<div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-green-500">`;
                Check($$payload4, { class: "h-4 w-4" });
                $$payload4.out += `<!----></div>`;
              } else {
                $$payload4.out += "<!--[!-->";
                $$payload4.out += `<div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-red-500">`;
...
const en_verify_token_error_min_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Your one-time password must be at least 6 characters`;
  }
);
const es_verify_token_error_min_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Tu contraseña de un solo uso debe tener al menos 6 caracteres`;
  }
);
const verify_token_error_min_length = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("verify_token_error_min_length", locale);
  if (locale === "en") return en_verify_token_error_min_length();
  if (locale === "es") return es_verify_token_error_min_length();
  return "verify_token.error.min_length";
};
const en_setting_username_error_min_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Username must be at least 3 characters`;
  }
);
const es_setting_username_error_min_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `El nombre de usuario debe tener al menos 3 caracteres`;
  }
);
const setting_username_error_min_length = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_username_error_min_length", locale);
  if (locale === "en") return en_setting_username_error_min_length();
  if (locale === "es") return es_setting_username_error_min_length();
  return "setting.username.error.min_length";
};
const en_setting_username_error_max_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Username must contain at most 30 character(s)`;
  }
);
const es_setting_username_error_max_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `El nombre de usuario debe contener como máximo 30 caracteres`;
  }
);
const setting_username_error_max_length = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_username_error_max_length", locale);
  if (locale === "en") return en_setting_username_error_max_length();
  if (locale === "es") return es_setting_username_error_max_length();
  return "setting.username.error.max_length";
};
const en_setting_username_error_alphanumeric = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Username must contain only letters and numbers`;
  }
);
const es_setting_username_error_alphanumeric = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `El nombre de usuario debe contener solo letras y números`;
  }
);
const setting_username_error_alphanumeric = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_username_error_alphanumeric", locale);
  if (locale === "en") return en_setting_username_error_alphanumeric();
  if (locale === "es") return es_setting_username_error_alphanumeric();
  return "setting.username.error.alphanumeric";
};
const en_setting_email_error_invalid = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Please enter a valid email address.`;
  }
);
const es_setting_email_error_invalid = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Por favor, ingresa una dirección de correo electrónico válida.`;
  }
);
const setting_email_error_invalid = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_email_error_invalid", locale);
  if (locale === "en") return en_setting_email_error_invalid();
  if (locale === "es") return es_setting_email_error_invalid();
  return "setting.email.error.invalid";
};
const en_setting_password_error_min_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Your password must be at least 8 characters`;
  }
);
const es_setting_password_error_min_length = (
  /** @type {(inputs: {}) => string} */
  () => {
    return `Tu contraseña debe tener al menos 8 caracteres`;
  }
);
const setting_password_error_min_length = /* @__NO_SIDE_EFFECTS__ */ (inputs = {}, options = {}) => {
  const locale = options.locale ?? getLocale();
  trackMessageCall("setting_password_error_min_length", locale);
  if (locale === "en") return en_setting_password_error_min_length();
  if (locale === "es") return es_setting_password_error_min_length();
  return "setting.password.error.min_length";
};
...
const usernameSchema = z.string().min(3, /* @__PURE__ */ setting_username_error_min_length()).max(30, /* @__PURE__ */ setting_username_error_max_length()).refine((username) => isValidUsername(username), {
  message: /* @__PURE__ */ setting_username_error_alphanumeric()
});
const emailSchema = z.string().email({
  message: /* @__PURE__ */ setting_email_error_invalid()
});
const passwordSchema = z.string().min(8, {
  message: /* @__PURE__ */ setting_password_error_min_length()
});
const otpSchema = z.string().min(6, {
  message: /* @__PURE__ */ verify_token_error_min_length()
});
...
function superForm(form, formOptions) {
      ...
      for (const postedForm of Context_findValidationForms(postedData).reverse()) {
        if (postedForm.id == _initialFormId && !initialForms.has(postedForm)) {
          ...
          if (form.valid && options.resetForm && (options.resetForm === true || options.resetForm())) {
            form = clone$2(pageDataForm);
            form.message = clone$2(postedForm.message);
          }
          break;
        }
      }
    } else {
      form = clone$2(initialForm);
    }
    onDestroy(() => {
  ...
  const __data = {
    formId: form.id,
    form: clone$2(form.data),
    constraints: form.constraints ?? {},
    posted: form.posted,
    errors: clone$2(form.errors),
    message: clone$2(form.message),
    tainted: void 0,
    valid: form.valid,
    submitting: false,
    shape: form.shape
  ...
  function Form_reset(opts = {}) {
    ...
    const resetData = clone$2(initialForm);
  ...
  const Unsubscriptions = [
    ...
    Tainted.state.subscribe((tainted) => __data.tainted = clone$2(tainted)),
    // eslint-disable-next-line dci-lint/private-role-access
    Form$1.subscribe((form2) => __data.form = clone$2(form2)),
    Errors.subscribe((errors) => __data.errors = clone$2(errors)),
      ...
      if (!cancelled) {
        ...
        if (!cancelled) {
          ...
          if (Form_isSPA()) {
            ...
            if (!validation)
              validation = await validateForm();
            const postData = clone$2(jsonData ?? validation.data);
...
export { Control as C, Form_ident_input as F, Form_button as a, Form_field as b, Form_field_errors as c, Form_label as d, emailSchema as e, Form_button$1 as f, zodClient as g, otpSchema as o, passwordSchema as p, superForm as s, usernameSchema as u, zod as z };
//# sourceMappingURL=superForm-DTuNRgSU.js.map
