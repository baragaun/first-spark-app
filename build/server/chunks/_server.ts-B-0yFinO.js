      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <img class="card-image" src="${walletItemProduct.imageSourceFront ? `${giftCardImageDomain}/giftcards/${walletItemProduct.imageSourceFront}` : "placeholder-image-url"}" />
...
export { POST };
//# sourceMappingURL=_server.ts-B-0yFinO.js.map
